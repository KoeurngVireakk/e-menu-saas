...
const variants = {
  ...
  success: "bg-emerald-600 text-white shadow-lg shadow-emerald-600/20 hover:-translate-y-0.5 hover:bg-emerald-700 focus-visible:ring-emerald-500",
  outline: "border border-blue-200 bg-white text-blue-700 shadow-sm shadow-blue-900/5 hover:-translate-y-0.5 hover:bg-blue-50 focus-visible:ring-blue-500",
};
