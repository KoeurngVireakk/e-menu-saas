  ...
  return (
    <AppCard bodyClassName="p-4">
      <div className="flex items-start justify-between gap-3">
        <div>
          <p className="text-xs font-black uppercase tracking-wide text-blue-600">Payment status</p>
      ...
      {payment ? (
        ...
        <p className="mt-4 inline-flex items-center gap-2 rounded-2xl bg-blue-50 p-3 text-sm font-semibold text-blue-800"><Upload className="h-4 w-4" aria-hidden="true" />Choose a payment method and submit proof if requested.</p>
      )}
    </AppCard>
  );
}
