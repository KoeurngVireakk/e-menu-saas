...
export default function Textarea({ label, description, error, className = "", id, ...props }) {
  ...
  return (
    <div>
      <label htmlFor={textareaId} className="khmer-label block text-sm font-bold text-slate-700">{label}</label>
