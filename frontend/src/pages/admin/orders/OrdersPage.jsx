...
import { canManageInvoices, canManageOrders } from "../../../utils/permissions";
      ...
      {selected ? (
        <div className="rounded-md border border-slate-200 bg-white p-4">
          <div className="flex items-center justify-between gap-3">
            ...
            <button onClick={() => { setSelected(null); setReceipt(null); }} className="rounded-md border border-slate-300 px-3 py-1 text-sm">Close</button>
          </div>
